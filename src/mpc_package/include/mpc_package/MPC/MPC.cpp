...
// Set cost factors
/// Tune cost factors
const int cost_cte_factor = 5000;
const int cost_epsi_factor = 100; // made initial portion etc much less snaky
const int cost_v_factor = 50;
const int cost_current_delta_factor = 1;
const int cost_diff_delta_factor = 50;
...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
  ...
  {
    vars_upperbound[i] = M_PI/6; // max values allowed in simulator
